...
class Test_Products():
    def test_products(self):
        ...
        home_page.ProductClass_to_Cart(product1)

        # Back to Shopping
        cart_page.Back_To_Products()

        # Add Bike Light to cart
        home_page.ProductClass_to_Cart(product2)
        ...
        home_page.GoToCart()
        cart_page.Verify_Product_Cart(product1)
        cart_page.Verify_Product_Cart(product2)
